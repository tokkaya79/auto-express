  ...
  <header class="header">
    <div class="container">
      <div class="header__top">
        <?php the_custom_logo(); ?>
        <a class="phone" href="<?php the_field('phoneNumber');?>"><?php the_field('phone');?></a>
      </div>
      <div class="header__content">
        ...
        <div class="social header__social">
          ...
          <a class="social__link" href="<?php the_field('telegramm-link');?>">
        ...
        <img data-wow-delay="2s" class="header__images wow animate__fadeInUpBig" src="<?php the_field('image-header'); ?>"
          alt="ford mustang">
      </div>
    </div>
